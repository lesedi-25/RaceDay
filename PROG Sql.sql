...
/* ============================================================
   SAMPLE DATA
   Insertion order relies on IDENTITY auto-numbering starting
   at 1, so IDs referenced in later inserts are known in advance:
     Users:       1,2 = Organisers | 3,4 = Participants
     Events:      1 = Marathon | 2 = Fun Run | 3 = Trail Challenge
   ============================================================ */
...
VALUES
    (1, 3, 1, 'Active'),   -- Enrolment 1: Lindiwe -> Marathon, Open Marathon
    (1, 4, 2, 'Active'),   -- Enrolment 2: Ben -> Marathon, Masters
    (2, 3, 4, 'Active'),   -- Enrolment 3: Lindiwe -> Fun Run, Open Fun Run
    (3, 4, 6, 'Active');   -- Enrolment 4: Ben -> Trail Challenge, Novice Trail
GO

-- ---------- Results ----------
INSERT INTO Results (EnrolmentId, FinishTime, Position, Status)
VALUES
    (1, '03:45:22', 12, 'Finished'),  -- Lindiwe's marathon result
    (2, '04:10:05', 25, 'Finished'),  -- Ben's marathon result
    (3, NULL,       NULL, 'DNF');     -- Lindiwe did not finish the fun run
    -- Enrolment 4 (Ben, Trail Challenge) intentionally has no result yet (event hasn't happened)
GO
